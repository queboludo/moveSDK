...
SWIFT_MODULE_NAMESPACE_PUSH("MoveSDK")

SWIFT_CLASS("_TtC7MoveSDK15MoveSDKGestures")
@interface MoveSDKGestures : NSObject
...
SWIFT_CLASS("_TtC7MoveSDK21MoveSDKViewController")
@interface MoveSDKViewController : UIViewController <AVPictureInPictureControllerDelegate, IMAAdsLoaderDelegate, IMAAdsManagerDelegate, GADAppEventDelegate, GADBannerViewDelegate, GADInterstitialDelegate>
...
- (void)adView:(GADBannerView * _Nonnull)banner didReceiveAppEvent:(NSString * _Nonnull)name withInfo:(NSString * _Nullable)info;
- (void)interstitial:(GADInterstitial * _Nonnull)interstitial didReceiveAppEvent:(NSString * _Nonnull)name withInfo:(NSString * _Nullable)info;
